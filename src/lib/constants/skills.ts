...
export const SKILL_CATEGORIES: readonly SkillCategory[] = [
  {
    ...
    skills: [
      ...
      { name: "Next.js / React", years: 1, isMain: true },
      { name: "TypeScript", years: 1, isMain: true },
      { name: "Tailwind CSS", years: 1, isMain: true },
  ...
  },
  {
    ...
    skills: [
      { name: "AWS Lambda", years: 2, isMain: true },
      { name: "AWS S3", years: 2, isMain: true },
      { name: "AWS DynamoDB", years: 2, isMain: true },
      ...
      { name: "GitHub Actions", years: 1, isMain: false },
